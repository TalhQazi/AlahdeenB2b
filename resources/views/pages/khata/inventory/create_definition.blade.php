...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        ...
        <form id="product_definition_form" action="{{ route('khata.inventory.product.definition.store') }}" method="POST" enctype="multipart/form-data" class="mt-10">
            @csrf
            <div class="grid grid-flow-row grid-cols-2 grid-rows-12 gap-x-20 gap-y-4 mb-10">
                ...
                <div class="col-span-1 row-span-6">
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="product_code" id="product_code" type="text">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="product_name">{{ __('Product Name') }}</label>
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="product_name" id="product_name" type='text'>
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="brand_name" id="brand_name" type='text'>
                    </div>
                </div>
                ...
                <div class="col-span-1 row-span-5">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="conversion_factor" id="conversion_factor" value="1" type="text">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="tax_code" id="tax_code" type="text">
                    </div>
                </div>
                <div class="col-span-1 row-span-6">
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded" name="product_group" id="product_group">
                                ...
                                <option value="casual use">{{ __('Casual Use') }}</option>
                            </select>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                            </div>
                    ...
                    <div class="w-1/4 md:w-full px-3 mb-5">
                        ...
                        {{__('Purchased')}}
                        <input class="inline-block bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="accquire_type" id="accquire_type" value="purchased" type="radio">
                        {{__('Manafactured')}}
                        <input class="inline-block bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="accquire_type" id="accquire_type" value="manafactured" type="radio">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded" name="additional_attributes" id="additional_attributes">
                                ...
                                <option value="out sourced">{{ __('Outsourced') }}</option>
                            </select>
                            <div class="pointer-events-none absolute top-0 mt-3  right-0 flex items-center px-2 text-gray-600">
                                <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z"/></svg>
                            </div>
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none inline w-96 bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="purchase_production_interval" id="purchase_production_interval" type="text" placeholder="5">
                ...
                <div class="col-span-2">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="brand_name">{{ __('Any Additional Product Description') }}</label>
                        <textarea
