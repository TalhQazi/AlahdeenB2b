...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        ...
        <form id="product_pricing_form" action="{{ route('khata.inventory.product.pricing.store') }}" method="POST" class="mt-10">
            @csrf
            <div class="grid grid-flow-row grid-cols-2 grid-rows-12 gap-x-20 gap-y-4 mb-10">
                ...
                <div class="col-span-1 row-span-12">
                        ...
                        <div class="flex-shrink w-full inline-block relative">
                            <select class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded" name="product_id" id="product_id">
                                ...
                                @foreach ($products as $product)
                                    @if (!empty(old('product_id')) && $product->id == old('product_id'))
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none focus:border-gray-500"
                                name="total_units" id="total_units" type="text" value="{{ old('total_units') }}">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none focus:border-gray-500"
                                name="price_per_unit" id="price_per_unit" type="text" value="{{ old('price_per_unit') }}">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none focus:border-gray-500"
                            name="avg_cost_per_unit" id="avg_cost_per_unit" type="text" value="{{ old('avg_cost_per_unit') }}">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="sales tax">{{ __('Sales Tax') }}</label>
                        <input class="appearance-none inline w-96 bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500" name="sales_tax_percentage" id="sales_tax_percentage"
                            type="text" placeholder="{{ __('Sales Tax %') }}" value="{{ old('sales_tax_percentage') }}">
                    ...
                    <div class="w-1/4 md:w-full px-3 mb-5">
                        ...
                        <input class="inline-block bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                            name="allow_below_cost_sale" id="allow_below_cost_sale" type="checkbox" value="{{ old('allow_below_cost_sale') != '' ? 'checked' : ''}}">
                    </div>
                    <div class="w-1/4 md:w-full px-3 mb-5">
                        {{__('Allow Price Change')}}
                        <input class="inline-block bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                            name="allow_price_change" id="allow_price_change" type="checkbox" value="{{ old('allow_price_change') != '' ? 'checked' : ''}}">
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input class="appearance-none inline w-96 bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                            name="discount_percentage" id="discount_percentage" type="text" placeholder="{{ __('Discount %') }}" value="{{ old('discount_percentage') }}">
                ...
                <div class="col-span-1 row-span-12 mt-6 ml-10" id="add_product_pricing_promotion">
                    <button type="button" class="btn btn-teal hidden" id="view_promotional_button"><i class="fas fa-eye"></i>{{ __(' View Promotional Product') }}</button>
                    <button type="button" class="btn btn-blue hidden" id="add_promotional_button"><i class="fas fa-plus"></i>{{ __(' Add Promotional Product') }}</button>
                </div>
