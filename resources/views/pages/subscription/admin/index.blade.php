...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        ...
        <div class="bg-white pb-4 px-4 rounded-md w-full">
           ...
           @include('components.subscription.admin.index.load')
        </div>
...
@section('modals')
    @include('components.subscription.admin.index.edit-status-modal')
@endsection
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/admin_subscriptions_index.js')) }}"></script>
@endpush
