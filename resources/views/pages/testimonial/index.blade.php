...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        <div class="card-header">
            ...
            <button id="add_testimonial_btn" data-url="{{route('admin.testimonials.store')}}" class="btn btn-gray xs:float-none sm:float-none md:float-none float-right sm:mt-2" >
                {{__('Add Testimonials')}}
        ...
        <div class="bg-white pb-4 px-4 rounded-md w-full">
           ...
           @include('components.testimonial.index.load')
        </div>
...
@section('modals')
    @include('components.testimonial.add-edit-testimonial-modal')
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/testimonial_index.js')) }}"></script>
