...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        <div class="card-header">{{ __('Matter Sheet Products List') }}</div>
        <div class="bg-white pb-4 px-4 rounded-md w-full">
            ...
            @include('pages.matter-sheet.listings.product.load')
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/admin_product_index.js')) }}"></script>
@endpush
