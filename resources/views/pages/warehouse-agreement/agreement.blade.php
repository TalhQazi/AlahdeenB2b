    ...
    <div class="min-h-screen pt-2 font-mono">
        <div class="container mx-auto">
            <div class="inputs w-full p-6">
                <h2 class="text-2xl text-gray-900">{{__('Invoice Payment')}}</h2>
                <form id="booking_agreement_form" class="mt-6 border-t border-gray-400 pt-4" method="POST" action="{{route('warehousebookings.create-payment', ['booking_agreement_term' => $warehouse_booking->id])}}">
                    @csrf
                    ...
                    <div class="my-5 float-right">
                        {{-- <button type="input" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" id="reject-btn">
                            {{__('Reject')}}
                        </button> --}}
