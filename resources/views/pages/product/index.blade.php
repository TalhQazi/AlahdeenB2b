...
@push('styles')
    <link rel="stylesheet" href="{{ asset(('css/pages/products_index.css')) }}">
@endpush
...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        ...
        <div class="bg-white pb-4 px-4 rounded-md w-full">
            ...
            @include('components.products.index.load')
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/products_index.js')) }}"></script>
@endpush
