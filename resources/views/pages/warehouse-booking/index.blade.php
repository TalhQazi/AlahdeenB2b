...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        ...
        <div class="bg-white pb-4 px-4 rounded-md w-full">
           ...
           @include('components.warehouse.index.load')
        </div>
...
@section('modals')
    @include('components.warehouse-booking.index.edit-modal')
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/warehouse_booking_index.js')) }}"></script>
@endpush
