...
@section('page')
    ...
    <div class="card col-span-2 xl:col-span-1">
        <div class="card-header">
            {{ __('Warehouses Booking Schedule') }}
        </div>
        <div class="bg-white pb-4 px-4 rounded-md w-full">
           ...
           <div class="overflow-x-auto mt-6 search_results" id="warehouse">
              <div id="calendar"></div>
            </div>
        </div>
...
@section('modals')
    ...
    @include('components.warehouse-booking.add-modal')
@endsection
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset(('js/pages/warehouse_booking.js')) }}"></script>
@endpush
