<div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-75 z-10 hidden" id="edit-product-interests-modal">
    <div class="bg-white rounded-lg w-1/2 sm:w-3/4">
      <div class="flex flex-col items-start p-4">
        ...
        <div class="w-full mt-6">
            <form id="add-product-interest-form" method="POST" action="{{route('product.interest.update')}}"  class="w-full">
                @csrf
                @method('PUT')
                <div class='flex flex-wrap -mx-3 mb-6'>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        ...
                        <input class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' name="quantity" id='quantity' type='text' min="1" required>
                    </div>
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='grid-text-1'>Quantity</label>
