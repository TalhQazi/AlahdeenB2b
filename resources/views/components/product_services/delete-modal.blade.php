<div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-75 hidden" id="delete-modal">
    <div class="bg-white rounded-lg w-1/2">
      <div class="flex flex-col items-start p-4">
        ...
        <hr>
        <div class="ml-auto">
            <form id="update_keywords_form">
                <input type="hidden" name="product_service_id" id="product_service_id">
                <input type="hidden" name="deleted_keyword" id="deleted_keyword">
                <input type="hidden" name="parent_span_id" id="parent_span_id">
