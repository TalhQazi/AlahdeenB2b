        ...
        <div class="w-full mt-6">
            <form id="booking_form" method="POST" class="w-full">
                ...
                <div class='flex flex-wrap -mx-3 mb-6'>
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="booking_status">
                            {{ __('Booking Status') }}
                        </label>
                        <select class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded" name="booking_status" id="booking_status">
