<div class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-75 modal hidden" id="delete-certification-modal">
    <div class="bg-white rounded-lg w-1/2">
      <div class="flex flex-col items-start p-4">
        ...
        <hr>
        <div class="ml-auto">
            <form id="delete_certification_form" method="POST">
                @csrf
                @method('DELETE')
