...
addMoreDocumentsBtn.onclick = function() {
    document.getElementById('add-product-documents-modal').classList.remove('hidden');
}

var bindCloseFunction = function bindCloseModal(element) {
    document.getElementById('add-product-documents-modal').classList.add('hidden');
...
confirmAddMoreBtn.onclick = function () {
    document.getElementById('add-product-doc-form').submit();
}
...
var deleteDocBtn = document.getElementsByClassName('delete-document');
