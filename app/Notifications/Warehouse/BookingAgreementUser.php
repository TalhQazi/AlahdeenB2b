...
class BookingAgreementUser extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        ->line(__('Following are the final details agreed upon for finalizing your request for booking warehouse: '))
        ...
        ->action('View Invoice', route('warehousebookings.view-invoice', ['booking_agreement_term' => $this->agreementDetails->id]))
    ...
    {
        // TODO: add remove any more details related to warehouse booking agreement
        $url = route('warehousebookings.view-invoice', ['booking_agreement_term' => $this->agreementDetails->id]);
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'user_terms' => $this->agreementDetails->user_terms
        ];
    }
}
