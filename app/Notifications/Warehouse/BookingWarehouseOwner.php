...
* to warehouse owner in case any user tries to book his warehouse
*/
class BookingWarehouseOwner extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line(__('Here is a request for booking your warehouse. Following are the details provided by the user for booking your warehouse: '))
    ...
    public function toSms($notifiable)
    {
        ...
        $url = url('Notification for warehouse booking request being received for his warehouse');
