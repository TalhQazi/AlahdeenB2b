...
return [
    ...
    'digit' => env('OTP_DIGIT', 6),
    'resend' => env('OTP_RESEND_SERVICE', 'enabled'),
    'max-retry' => env('OTP_MAX_RETRY', 2),
    'max-resend' => env('OTP_MAX_RESEND', 2),
    'service-name' => env('OTP_SERVICE_NAME', 'OTP Service'),
    'company-name' => env('OTP_COMPANY_NAME', 'Emandii.com'),
    'send-by' => [
        'email' => env('OTP_SEND_BY_EMAIL', 0),
        'sms' => env('OTP_SEND_BY_SMS', 1)
    ],
    'email' => [
        'from' => env('OTP_EMAIL_FROM', 'noreply@emandii.com'),
        'name' => env('OTP_EMAIL_FROM_NAME', 'Emandii.com'),
